    ...
    <PageContainer imgUrl="/images/home_hero.jpg">
      <SectionContainer>
        <div className="flex flex-col items-center justify-center gap-3">
          <div className="flex flex-col items-center gap-3 text-[#00D8D8] font-semibold">
            <h2 className="text-7xl">Personal Training Zurich</h2>
            <h2 className="text-7xl">Science-Driven Fitness & Longevity</h2>
          </div>
          <div className="flex flex-col items-center gap-3 mt-8">
            <h3 className="text-5xl"> We Take Challenges</h3>
            <h3 className="text-5xl">Others Consider Impossible</h3>
          </div>
      ...
      <SectionContainer className="bg-white text-center">
        <div className="mx-auto max-w-screen-lg px-6">
          <h2 className="text-[36px] sm:text-[42px] font-semibold text-black leading-tight [text-wrap:balance]">Optimize Your Health & Extend Your Lifespan</h2>
          <h3 className="mt-6 text-xl sm:text-4xl text-black leading-relaxed max-w-[70ch] mx-auto [text-wrap:balance] p-4">
          ...
          <h2 className="text-[36px] sm:text-[42px] mt-8  font-semibold text-black leading-tight [text-wrap:balance]">With Relysian, you don’t just train — you evolve.</h2>
        </div>
      </SectionContainer>
        ...
        <div className="mx-auto w-full max-w-screen-xl px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mx-10 place-items-center">
            <div className="flex flex-col items-center text-center gap-6">
              <h3 className="text-3xl sm:text-4xl font-semibold text-white leading-tight [text-wrap:balance]">Start your journey with Relysian</h3>
